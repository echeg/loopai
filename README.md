...
requires Python 3 for its deterministic path helper and Git plus `tar` for a
Codex snapshot that excludes ignored files and every symlink path. Standalone
