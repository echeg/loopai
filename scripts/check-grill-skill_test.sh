...
assert_contains "missing decision-log accepted entry format" '- <YYYY-MM-DD> grill: **accepted** - <what changed and where>'
assert_contains "missing decision-log rejected entry format" '- <YYYY-MM-DD> grill: **rejected** - "<the finding>"'
