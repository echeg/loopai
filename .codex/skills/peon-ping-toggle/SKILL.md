...
description: >-
  Toggle peon-ping sound notifications on/off. Use when user wants to mute,
  unmute, pause, or resume peon sounds during a Claude Code session. Also
  handles config changes like volume, pack rotation, categories — any peon-ping
  setting.
---
# peon-ping-toggle
...
```bash
bash "/Users/echeg/Projects/IdleMerge/.claude/hooks/peon-ping"/peon.sh toggle
```
