...
description: >-
  ...
  Automatically enables session_override rotation mode if not already set. Use
  when user wants a specific character voice like GLaDOS, Peon, or Kerrigan for
  this conversation.
---
# peon-ping-use
...
```bash
cat "/Users/echeg/Projects/IdleMerge/.claude/hooks/peon-ping"/config.json
```
...
```bash
cat "/Users/echeg/Projects/IdleMerge/.claude/hooks/peon-ping"/.state.json
```
