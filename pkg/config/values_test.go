...
func TestValuesLoader_Load_EmbeddedOnly(t *testing.T) {
	...
	assert.Equal(t, []string{"Rate limit exceeded", "rate limit reached", "429 Too Many Requests", "quota exceeded", "insufficient_quota", "You've hit your usage limit", "is at capacity"}, values.CodexLimitPatterns)
