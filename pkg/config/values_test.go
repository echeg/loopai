...
func TestValuesLoader_Load_EmbeddedOnly(t *testing.T) {
	...
	assert.Equal(t, []string{"You've hit your limit", "You've hit your session limit", "Your usage allocation has been disabled by your admin", "You've hit your org's monthly usage limit", "You're out of usage credits", "You've hit your individual spend limit"}, values.ClaudeLimitPatterns)
