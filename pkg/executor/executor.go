...
// CLAUDE_CODE, CLAUDE_CODE_PARENT_SESSION_ID, and CLAUDE_CODE_SSE_PORT extend the upstream
// list with the session-identity keys cmux's claude launch policy also clears.
