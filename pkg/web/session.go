...
type SessionMetadata struct {
	...
	ReviewModel         string    // model[:effort] spec for primary review phases (from "Review model:" header line)
	ExternalReview      string    // effective external provider (from "External review:" header line)
	ExternalReviewModel string    // external model[:effort] (from "External review model:" header line)
