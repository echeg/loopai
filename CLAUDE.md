...
its fixes are committed and the tree is clean, and it is resumed only while its recorded HEAD is an
ancestor of the current branch tip; new task-phase commits invalidate the checkpoint. Finalize is
